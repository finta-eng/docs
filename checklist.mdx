...
Your legal name is simply what gets filed with the state, it doesn't have to match your brand. For example, Instacart incorporated as Maplebear Inc. back when the founders were still exploring ideas, and still uses that name today as a \$10B+ public company.
